...
### Authentication with Mamo

To get authenticated and start making API calls, you'll first need to retrieve your **API key** from the Mamo dashboard.
...
Alternatively, you can follow this direct link to access your API key: [Get Your API Key](https://business.mamopay.com/manage_api/v1/me).

#### Step 2: Test Authentication

Once you have your API key, use the following cURL command to test authentication:
